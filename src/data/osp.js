...
export const OSP_MODULES = [
    ...
    screens: [
      {
        ...
        takeaway: "Short screens, quick questions, unlimited retries — this pathway is about understanding, not catching you out.",
      },
      {
        ...
        body: [
          ...
          "Each module ends with eight quick questions on what you just read. You need six out of eight to pass — and you can retry as many times as you like. The feedback is the teaching.",
        ],
  ...
  // ──────────────────────────────────────────────────────────────── S1 ──
  {
    ...
    subtitle: "Six screens and eight questions, about eight minutes",
    minutes: 8,
    icon: "public",
    screens: [
      {
    ...
    quiz: [
      ...
      {
        format: "single",
        stem: "A borrow pit left open and full of water when we finish is an example of…",
        image: "/images/quarry-pit.jpg",
        options: ["What we do to the place.", "What we do to people.", "Governance.", "Nothing — pits are temporary."],
        correct: 0,
        general: "It is one of the five examples on the 'What we do to the place' screen — and almost all of it is cheap to prevent.",
      },
      {
        format: "single",
  ...
  // ──────────────────────────────────────────────────────────────── S2 ──
  {
    ...
    screens: [
      ...
      },
      {
        ...
        photo: "/images/african-roadworks2.jpg",
        body: [
    ...
    quiz: [
      ...
      {
        format: "single",
        stem: "Who applies the IFC Performance Standards to our project?",
        image: "/images/african-roadworks.jpg",
        options: ["The lenders, through the financing agreement.", "The weather bureau.", "Only the regulator.", "Nobody — they are optional."],
        correct: 0,
        general: "Voluntary for a bank, contractual for us: once they are in the financing agreement, they bind this project.",
      },
      {
        format: "tf",
  ...
  // ──────────────────────────────────────────────────────────────── S3 ──
  {
    ...
    quiz: [
      ...
      {
        format: "single",
        stem: "What sits under the ESMP?",
        image: "/images/lm4.jpg",
        options: ["The daily plans and procedures that run the work.", "The lenders' contracts.", "Only policies.", "Nothing — it stands alone."],
        correct: 0,
        general: "Traffic, waste, borrow pits, camp, engagement, emergency — and under the plans, the procedures people use every day.",
      },
    ],
  ...
  // ──────────────────────────────────────────────────────────────── S4 ──
  {
    ...
    screens: [
      ...
      },
      {
        ...
        photo: "/images/african-worker.jpg",
        body: [
    ...
    quiz: [
      ...
      {
        format: "single",
        stem: "What are the three things the consultant compares?",
        image: "/images/lm10.jpg",
        options: ["The documents, the site, and the people.", "Price, programme and quality.", "Only the documents.", "Weather, water and waste."],
        correct: 0,
        general: "Where the three disagree, the disagreement is the finding.",
      },
      {
        format: "single",
  ...
  // ──────────────────────────────────────────────────────────────── S5 ──
  {
    ...
    quiz: [
      ...
      {
        format: "single",
        stem: "The chain from your day to a payment is…",
        image: "/images/esg-reporting.jpg",
        options: ["Procedure followed → record made → plan proved → action closed → payment released.", "Invoice → payment.", "Meeting → report.", "There is no chain."],
        correct: 0,
        general: "Five steps from a form at the gate to a decision at a bank. It is shorter than anyone thinks.",
      },
    ],
  ...
  // ──────────────────────────────────────────────────────────────── R1 ──
  {
    ...
    order: 6,
    title: "Community",
    subtitle: "Eight screens and eight questions, about twelve minutes",
    minutes: 12,
    icon: "diversity_3",
    screens: [
      {
      ...
      },
      {
        ...
        photo: "/images/african-village.jpg",
        body: [
    ...
    quiz: [
      ...
      {
        format: "single",
        stem: "A complaint is truly closed when…",
        image: "/images/african-village.jpg",
        options: ["It is logged.", "It is investigated.", "The complainant is told what was decided and why.", "Thirty days pass."],
        correct: 2,
        general: "That is the step everyone skips — and from the complainant's side, a case closed without being told is a case where nothing happened.",
      },
    ],
  ...
  // ──────────────────────────────────────────────────────────────── R2 ──
  {
    ...
    subtitle: "Nine screens and eight questions, about thirteen minutes",
    minutes: 13,
    ...
    screens: [
      ...
      },
      {
        ...
        photo: "/images/african-waterspray.jpg",
        body: [
    ...
    quiz: [
      ...
      {
        format: "single",
        stem: "Protective equipment is provided…",
        image: "/images/african-crew.jpg",
        options: ["Free — it is never deducted from a wage.", "Against a deposit.", "Only to our own employees.", "Once a year."],
        correct: 0,
        general: "And it is the LAST line of defence, not the plan.",
      },
      {
        format: "single",
  ...
  // ──────────────────────────────────────────────────────────────── R3 ──
  {
    ...
    quiz: [
      ...
      {
        format: "single",
        stem: "Before ANY clearance, somebody must…",
        image: "/images/esg-environment.jpg",
        options: ["Check what is there — habitat, species, wetlands, and the trees and plants people use.", "Inform the client.", "Take photographs afterwards.", "Nothing — clearance is routine."],
        correct: 0,
        general: "Screening after clearance tells you only what was lost.",
      },
    ],
  ...
  // ──────────────────────────────────────────────────────────────── R4 ──
  {
    ...
    quiz: [
      ...
      {
        format: "single",
        stem: "Someone tells you something difficult. You…",
        options: ["Investigate it yourself.", "Listen once, ask what they need, and pass it to the named trained person.", "Bring the two people together.", "Describe the case in your next report."],
        correct: 1,
        general: "Never promise you will tell nobody — be honest about who you will have to tell, before you tell anyone.",
      },
    ],
